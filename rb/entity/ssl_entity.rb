...
class SslEntity
  ...
  # @return [Ssl, Hash] the current Ssl data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Ssl fields)
  def match_get
  ...
  #
  # @param reqmatch [SslListMatch, Hash, nil] match filter (any subset of
  #   Ssl fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Ssl>, Array] the matching Ssl items; raises EmailValidationApi2Error on failure
