...
// EmailValidationApi2 SDK configuration

class EmailValidationApi2Config
{
    ...
    public static function make_config(): array
    {
        return [
            "main" => [
                "name" => "EmailValidationApi2",
                "slug" => "email-validation-api2",
                "version" => "0.0.1",
                "target" => "php",
            ],
            "feature" => [
    ...
    public static function make_feature(string $name)
    {
        ...
        return EmailValidationApi2Features::make_feature($name);
    }
}
