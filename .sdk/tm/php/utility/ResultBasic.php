...
// EmailValidationApi2 SDK utility: result_basic

class EmailValidationApi2ResultBasic
{
    public static function call(EmailValidationApi2Context $ctx): ?EmailValidationApi2Result
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof EmailValidationApi2Error) ? $result->err->msg : (string)$result->err;
