...
// EmailValidationApi2 SDK utility: feature_init

class EmailValidationApi2FeatureInit
{
    public static function call(EmailValidationApi2Context $ctx, mixed $f): void
    {
        $fname = $f->get_name();
        $fopts = [];
        if ($ctx->options) {
