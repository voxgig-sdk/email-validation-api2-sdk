...
class DnsResultDirectTest extends TestCase
{
    public function test_direct_load_dns_result(): void
    {
        $setup = dns_result_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-dns_result", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function dns_result_direct_setup($mockres)
{
