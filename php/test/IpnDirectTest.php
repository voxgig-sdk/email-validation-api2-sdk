...
class IpnDirectTest extends TestCase
{
    public function test_direct_load_ipn(): void
    {
        $setup = ipn_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-ipn", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function ipn_direct_setup($mockres)
{
