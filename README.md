...
const dnsresult = await client.DnsResult().load({ domain: "example" })
```
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/email-validation-api2-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/email-validation-api2-sdk/releases) |
| Python | `voxgig-sdk-email-validation-api2` | publish pending — [install from git tag](https://github.com/voxgig-sdk/email-validation-api2-sdk/releases) |
| PHP | `voxgig-sdk/email-validation-api2` | publish pending — [install from git tag](https://github.com/voxgig-sdk/email-validation-api2-sdk/releases) |
| Golang | `github.com/voxgig-sdk/email-validation-api2-sdk/go` | `go get github.com/voxgig-sdk/email-validation-api2-sdk/go@latest` |
| Ruby | `voxgig-sdk-email-validation-api2` | publish pending — [install from git tag](https://github.com/voxgig-sdk/email-validation-api2-sdk/releases) |
| Lua | `voxgig-sdk-email-validation-api2` | publish pending — [install from git tag](https://github.com/voxgig-sdk/email-validation-api2-sdk/releases) |
| Go CLI | `github.com/voxgig-sdk/email-validation-api2-sdk/go-cli` | `go install github.com/voxgig-sdk/email-validation-api2-sdk/go-cli/cmd/email-validation-api2@latest` |
| Go MCP server | `github.com/voxgig-sdk/email-validation-api2-sdk/go-mcp` | `go get github.com/voxgig-sdk/email-validation-api2-sdk/go-mcp@latest` |
...
```bash
cd go-mcp && go build -o email-validation-api2-mcp .
```
...
```json
{
  "mcpServers": {
    "email-validation-api2": {
      "command": "/abs/path/to/email-validation-api2-mcp"
    }
  }
}
```
...
```go
import sdk "github.com/voxgig-sdk/email-validation-api2-sdk/go"
