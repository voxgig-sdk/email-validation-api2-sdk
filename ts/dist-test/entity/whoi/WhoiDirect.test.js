...
(0, node_test_1.describe)('WhoiDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-whoi', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-whoi', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['EMAIL_VALIDATION_API2_TEST_WHOI_ENTID'];
...
//# sourceMappingURL=WhoiDirect.test.js.map