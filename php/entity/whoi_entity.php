...
// EmailValidationApi2 SDK Whoi entity
...
class WhoiEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new WhoiEntity($this->_client, $opts);
    }

    /**
     * @param Whoi|array $args Whoi data (assoc-array) to store.
     */
    ...
    /**
     * @return Whoi|array The current Whoi data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Whoi fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Whoi fields).
     */
    ...
    /**
     * List Whoi items matching the given filter.
     *
     * @param WhoiListMatch|array|null $reqmatch Match filter (any subset
     *   of Whoi fields) as an assoc-array; WhoiListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Whoi[]|array A list of Whoi items as assoc-arrays at
