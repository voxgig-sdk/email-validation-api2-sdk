...
// EmailValidationApi2 SDK utility: make_options

class EmailValidationApi2MakeOptions
{
    ...
    public static function call(EmailValidationApi2Context $ctx): array
    {
        ...
        //
        // `EmailValidationApi2Schema::optspec()` is built from the model:
        ...
        $optspec = EmailValidationApi2Schema::optspec();
