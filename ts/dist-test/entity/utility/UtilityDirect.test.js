...
(0, node_test_1.describe)('UtilityDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.EmailValidationApi2SDK({
    ...
    (0, node_test_1.test)('direct-load-utility', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-utility', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.EMAIL_VALIDATION_API2_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.EmailValidationApi2SDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.EMAIL_VALIDATION_API2_APIKEY,
        }));
        let idmap = env['EMAIL_VALIDATION_API2_TEST_UTILITY_ENTID'];
    ...
    const client = new __1.EmailValidationApi2SDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=UtilityDirect.test.js.map