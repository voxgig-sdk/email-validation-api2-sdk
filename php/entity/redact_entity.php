...
// EmailValidationApi2 SDK Redact entity
...
class RedactEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RedactEntity($this->_client, $opts);
    }

    /**
     * @param Redact|array $args Redact data (assoc-array) to store.
     */
    ...
    /**
     * @return Redact|array The current Redact data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Redact fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Redact fields).
     */
     ...
     * Create a new Redact.
     *
     * @param RedactCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RedactCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Redact|array The created Redact as an assoc-array at the
