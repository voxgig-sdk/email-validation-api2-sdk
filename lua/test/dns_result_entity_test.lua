...
describe("DnsResultEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set EMAILVALIDATIONAPI__TEST_DNS_RESULT_ENTID JSON to run live")
      return
    end
...
function dns_result_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("EMAILVALIDATIONAPI__TEST_DNS_RESULT_ENTID")
