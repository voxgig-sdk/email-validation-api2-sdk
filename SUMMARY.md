...
- `email-validation-api2_list`: List records for an entity. Supported entities: `domain`, `ssl`, `whoi`.
- `email-validation-api2_load`: Load one record for an entity. Supported entities: `dns_result`, `email_validate`, `generate`, `ipn`, `utility`.
