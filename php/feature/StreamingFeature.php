...
// EmailValidationApi2 SDK streaming feature
...
class EmailValidationApi2StreamingFeature extends EmailValidationApi2BaseFeature
{
    ...
    private function _iterate(EmailValidationApi2Result $result): \Generator
    {
    ...
    private function _streamable(EmailValidationApi2Context $ctx): bool
    {
