...
// EmailValidationApi2 SDK Grammar entity
...
class GrammarEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GrammarEntity($this->_client, $opts);
    }

    /**
     * @param Grammar|array $args Grammar data (assoc-array) to store.
     */
    ...
    /**
     * @return Grammar|array The current Grammar data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Grammar fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Grammar fields).
     */
     ...
     *
     * @param GrammarCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed GrammarCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Grammar|array The created Grammar as an assoc-array at the
