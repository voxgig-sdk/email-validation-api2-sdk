...
// EmailValidationApi2 SDK Generate entity
...
class GenerateEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GenerateEntity($this->_client, $opts);
    }

    /**
     * @param Generate|array $args Generate data (assoc-array) to store.
     */
    ...
    /**
     * @return Generate|array The current Generate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Generate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Generate fields).
     */
    ...
    /**
     * Load a single Generate.
     *
     * @param GenerateLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GenerateLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Generate|array The loaded Generate as an assoc-array at the
