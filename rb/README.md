# EmailValidationApi2 Ruby SDK



The Ruby SDK for the EmailValidationApi2 API — an entity-oriented client using idiomatic Ruby conventions.
...
client = EmailValidationApi2SDK.new({
...
```ruby
require_relative "EmailValidationApi2_sdk"
client = EmailValidationApi2SDK.new(options)
```
...
raise a `EmailValidationApi2Error` (a `StandardError` subclass), so wrap
...
```
rb/
├── EmailValidationApi2_sdk.rb       -- Main SDK module
...
The main module (`EmailValidationApi2_sdk`) exports the SDK class
