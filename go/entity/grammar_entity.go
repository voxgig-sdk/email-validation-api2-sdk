...
func NewGrammarEntity(client *core.EmailValidationApi2SDK, entopts map[string]any) *GrammarEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GrammarEntity) GetName() string { return e.name }
...
func (e *GrammarEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GrammarEntity) Deleted() bool {
	return e.deleted
}


func (e *GrammarEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGrammarEntity(e.client, opts)
}

func (e *GrammarEntity) Data(args ...any) any {
...
func (e *GrammarEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Grammar; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GrammarEntity) DataTyped(data ...Grammar) Grammar {
	if len(data) > 0 {
		return typedFrom[Grammar](e.Data(asMap(data[0])))
	}
	return typedFrom[Grammar](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Grammar (all fields
// optional at the wire level).
func (e *GrammarEntity) MatchTyped(match ...Grammar) Grammar {
	if len(match) > 0 {
		return typedFrom[Grammar](e.Match(asMap(match[0])))
	}
	return typedFrom[Grammar](e.Match())
}
...
func (e *GrammarEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GrammarEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *GrammarEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *GrammarEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GrammarCreateData and returns an Grammar. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *GrammarEntity) CreateTyped(reqdata GrammarCreateData, ctrl map[string]any) (Grammar, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Grammar{}, err
	}
	return typedFrom[Grammar](res), nil
}



func (e *GrammarEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GrammarEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GrammarEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
