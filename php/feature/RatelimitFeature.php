...
// EmailValidationApi2 SDK ratelimit feature
...
class EmailValidationApi2RatelimitFeature extends EmailValidationApi2BaseFeature
{
    ...
    private function _acquire(EmailValidationApi2Context $ctx): void
    {
    ...
    private function _track(EmailValidationApi2Context $_ctx, float $wait_ms): void
    {
        $client = $this->client;
