...
class GrammarEntity
  ...
  def make
    opts = @_entopts.dup
    GrammarEntity.new(@_client, opts)
  end
  ...
  # @return [Grammar, Hash] the current Grammar data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Grammar fields)
  def match_get
  ...
  #
  # @param reqdata [GrammarCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Grammar, Hash] the created Grammar; raises EmailValidationApi2Error on failure
