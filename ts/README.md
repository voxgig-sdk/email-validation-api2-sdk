# EmailValidationApi2 TypeScript SDK



The TypeScript SDK for the EmailValidationApi2 API — a type-safe, entity-oriented client with full async/await support.
...
- Releases: [https://github.com/voxgig-sdk/email-validation-api2-sdk/releases](https://github.com/voxgig-sdk/email-validation-api2-sdk/releases)
...
```ts
const client = EmailValidationApi2SDK.test()
...
```ts
const client = new EmailValidationApi2SDK({ apikey: '...' })
...
```ts
new EmailValidationApi2SDK(options?: {
  apikey?: string
  base?: string
  prefix?: string
  suffix?: string
...
| `tester(testopts?, sdkopts?)` | `EmailValidationApi2SDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `EmailValidationApi2SDK.test(testopts?, sdkopts?)` | `EmailValidationApi2SDK` | Create a test-mode client. |
...
| `client` | `client(): EmailValidationApi2SDK` | Return the parent SDK client. |
...
```
email-validation-api2/
├── src/
│   ├── EmailValidationApi2SDK.ts        # Main SDK class
