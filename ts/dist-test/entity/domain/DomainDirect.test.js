...
(0, node_test_1.describe)('DomainDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-domain', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-domain', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'EMAIL_VALIDATION_API2_TEST_DOMAIN_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['EMAIL_VALIDATION_API2_TEST_DOMAIN_ENTID'];
...
//# sourceMappingURL=DomainDirect.test.js.map