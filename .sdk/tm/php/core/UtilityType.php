...
// EmailValidationApi2 SDK utility type

class EmailValidationApi2Utility
{
    ...
    public static function copy(EmailValidationApi2Utility $src): EmailValidationApi2Utility
    {
        $u = new EmailValidationApi2Utility();
        $u->clean = $src->clean;
        $u->done = $src->done;
