...
func NewWhoiEntity(client *core.EmailValidationApi2SDK, entopts map[string]any) *WhoiEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WhoiEntity) GetName() string { return e.name }
...
func (e *WhoiEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WhoiEntity) Deleted() bool {
	return e.deleted
}


func (e *WhoiEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWhoiEntity(e.client, opts)
}

func (e *WhoiEntity) Data(args ...any) any {
...
func (e *WhoiEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Whoi; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WhoiEntity) DataTyped(data ...Whoi) Whoi {
	if len(data) > 0 {
		return typedFrom[Whoi](e.Data(asMap(data[0])))
	}
	return typedFrom[Whoi](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Whoi (all fields
// optional at the wire level).
func (e *WhoiEntity) MatchTyped(match ...Whoi) Whoi {
	if len(match) > 0 {
		return typedFrom[Whoi](e.Match(asMap(match[0])))
	}
	return typedFrom[Whoi](e.Match())
}
...
func (e *WhoiEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WhoiEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *WhoiEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WhoiListMatch and returns []Whoi. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *WhoiEntity) ListTyped(reqmatch WhoiListMatch, ctrl map[string]any) ([]Whoi, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Whoi](res), nil
}



func (e *WhoiEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WhoiEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WhoiEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WhoiEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
