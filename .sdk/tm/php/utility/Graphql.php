...
// EmailValidationApi2 SDK utility: graphql
//
...
class EmailValidationApi2Graphql
{
    ...
    // equivalent.
    public static function body(EmailValidationApi2Context $ctx): mixed
    {
    ...
    public static function errors(EmailValidationApi2Context $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
