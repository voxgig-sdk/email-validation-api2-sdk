...
func NewRedactEntity(client *core.EmailValidationApi2SDK, entopts map[string]any) *RedactEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RedactEntity) GetName() string { return e.name }
...
func (e *RedactEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RedactEntity) Deleted() bool {
	return e.deleted
}


func (e *RedactEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRedactEntity(e.client, opts)
}

func (e *RedactEntity) Data(args ...any) any {
...
func (e *RedactEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Redact; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RedactEntity) DataTyped(data ...Redact) Redact {
	if len(data) > 0 {
		return typedFrom[Redact](e.Data(asMap(data[0])))
	}
	return typedFrom[Redact](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Redact (all fields
// optional at the wire level).
func (e *RedactEntity) MatchTyped(match ...Redact) Redact {
	if len(match) > 0 {
		return typedFrom[Redact](e.Match(asMap(match[0])))
	}
	return typedFrom[Redact](e.Match())
}
...
func (e *RedactEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RedactEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *RedactEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *RedactEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RedactCreateData and returns an Redact. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *RedactEntity) CreateTyped(reqdata RedactCreateData, ctrl map[string]any) (Redact, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Redact{}, err
	}
	return typedFrom[Redact](res), nil
}



func (e *RedactEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RedactEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RedactEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
