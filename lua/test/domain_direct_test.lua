...
describe("DomainDirect", function()
  it("should direct-list-domain", function()
    local setup = domain_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-domain", setup.live and "live" or "unit")
