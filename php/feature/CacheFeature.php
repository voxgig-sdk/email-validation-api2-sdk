...
// EmailValidationApi2 SDK cache feature
...
class EmailValidationApi2CacheFeature extends EmailValidationApi2BaseFeature
{
    ...
    private function _through(EmailValidationApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
