...
// EmailValidationApi2 SDK DnsResult entity
...
class DnsResultEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DnsResultEntity($this->_client, $opts);
    }

    /**
     * @param DnsResult|array $args DnsResult data (assoc-array) to store.
     */
    ...
    /**
     * @return DnsResult|array The current DnsResult data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DnsResult fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DnsResult fields).
     */
    ...
    /**
     * Load a single DnsResult.
     *
     * @param DnsResultLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DnsResultLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DnsResult|array The loaded DnsResult as an assoc-array at the
