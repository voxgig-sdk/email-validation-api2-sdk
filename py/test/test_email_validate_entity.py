    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set EMAILVALIDATIONAPI__TEST_EMAIL_VALIDATE_ENTID JSON to run live")
        client = setup["client"]
...
def _email_validate_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "EMAILVALIDATIONAPI__TEST_EMAIL_VALIDATE_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("EMAILVALIDATIONAPI__TEST_EMAIL_VALIDATE_ENTID"))
