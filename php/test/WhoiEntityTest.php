...
class WhoiEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set EMAIL_VALIDATION_API2_TEST_WHOI_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function whoi_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("EMAIL_VALIDATION_API2_TEST_WHOI_ENTID");
