...
class DomainDirectTest extends TestCase
{
    public function test_direct_list_domain(): void
    {
        $setup = domain_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-domain", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function domain_direct_setup($mockres)
{
