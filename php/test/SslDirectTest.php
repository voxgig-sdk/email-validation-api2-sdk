...
class SslDirectTest extends TestCase
{
    public function test_direct_list_ssl(): void
    {
        $setup = ssl_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-ssl", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function ssl_direct_setup($mockres)
{
