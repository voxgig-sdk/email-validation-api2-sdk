...
// EmailValidationApi2 SDK Ipn entity
...
class IpnEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new IpnEntity($this->_client, $opts);
    }

    /**
     * @param Ipn|array $args Ipn data (assoc-array) to store.
     */
    ...
    /**
     * @return Ipn|array The current Ipn data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Ipn fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Ipn fields).
     */
     ...
     * Load a single Ipn.
     *
     * @param IpnLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed IpnLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Ipn|array The loaded Ipn as an assoc-array at the
