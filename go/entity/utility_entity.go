...
func NewUtilityEntity(client *core.EmailValidationApi2SDK, entopts map[string]any) *UtilityEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UtilityEntity) GetName() string { return e.name }
...
func (e *UtilityEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UtilityEntity) Deleted() bool {
	return e.deleted
}


func (e *UtilityEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUtilityEntity(e.client, opts)
}

func (e *UtilityEntity) Data(args ...any) any {
...
func (e *UtilityEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Utility; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UtilityEntity) DataTyped(data ...Utility) Utility {
	if len(data) > 0 {
		return typedFrom[Utility](e.Data(asMap(data[0])))
	}
	return typedFrom[Utility](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Utility (all fields
// optional at the wire level).
func (e *UtilityEntity) MatchTyped(match ...Utility) Utility {
	if len(match) > 0 {
		return typedFrom[Utility](e.Match(asMap(match[0])))
	}
	return typedFrom[Utility](e.Match())
}
...
func (e *UtilityEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UtilityEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UtilityLoadMatch and returns an Utility. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *UtilityEntity) LoadTyped(reqmatch UtilityLoadMatch, ctrl map[string]any) (Utility, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Utility{}, err
	}
	return typedFrom[Utility](res), nil
}



func (e *UtilityEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *UtilityEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *UtilityEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UtilityEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UtilityEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
