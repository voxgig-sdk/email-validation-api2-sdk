...
local SDK_MODULE = "email-validation-api2_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["dns_result"] = { ["test01"] = { id = "test01" } }, ["domain"] = { ["test01"] = { id = "test01" } }, ["email_validate"] = { ["test01"] = { id = "test01" } }, ["generate"] = { ["test01"] = { id = "test01" } }, ["grammar"] = { ["test01"] = { id = "test01" } }, ["ipn"] = { ["test01"] = { id = "test01" } }, ["redact"] = { ["test01"] = { id = "test01" } }, ["ssl"] = { ["test01"] = { id = "test01" } }, ["utility"] = { ["test01"] = { id = "test01" } }, ["whoi"] = { ["test01"] = { id = "test01" } } } }'
