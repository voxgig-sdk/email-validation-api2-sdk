...
func registerSDKWords(r *eng.Registry, client *sdk.EmailValidationApi2SDK) {
...
func runOp(client *sdk.EmailValidationApi2SDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
