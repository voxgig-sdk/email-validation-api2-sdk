...
func TestIpnEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		ipnRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.ipn")))
...
func ipnBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("EMAIL_VALIDATION_API2_TEST_IPN_ENTID")
	...
	idmapResolved := core.ToMapAny(env["EMAIL_VALIDATION_API2_TEST_IPN_ENTID"])
