# EmailValidationApi2 SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions EmailValidationApi2SDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both EmailValidationApi2SDK(...) and EmailValidationApi2SDK.test(...) become
#      EmailValidationApi2SDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "emailvalidationapi2_sdk"
_SDK_CLASS = "EmailValidationApi2SDK"
