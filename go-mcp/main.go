// Command EmailValidationApi2-mcp is an MCP server exposing the EmailValidationApi2
// SDK as MCP tools.
//
// Two tools are registered:
//
//	EmailValidationApi2_list  — list records of an entity
//	EmailValidationApi2_load  — load a single record of an entity
//
