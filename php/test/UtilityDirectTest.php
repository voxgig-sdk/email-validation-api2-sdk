...
class UtilityDirectTest extends TestCase
{
    public function test_direct_load_utility(): void
    {
        $setup = utility_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-utility", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function utility_direct_setup($mockres)
{
