# EmailValidationApi2 Lua SDK



The Lua SDK for the EmailValidationApi2 API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/email-validation-api2-sdk/releases)),
...
```
lua/
├── email-validation-api2_sdk.lua    -- Main SDK module
...
The main module (`email-validation-api2_sdk`) exports the SDK constructor
