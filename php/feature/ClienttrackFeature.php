...
// EmailValidationApi2 SDK clienttrack feature
...
class EmailValidationApi2ClienttrackFeature extends EmailValidationApi2BaseFeature
{
    ...
    public function PostConstruct(EmailValidationApi2Context $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'EmailValidationApi2-SDK';
