...
class WhoiDirectTest extends TestCase
{
    public function test_direct_list_whoi(): void
    {
        $setup = whoi_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-whoi", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function whoi_direct_setup($mockres)
{
