...
// EmailValidationApi2 SDK paging feature
...
class EmailValidationApi2PagingFeature extends EmailValidationApi2BaseFeature
{
    ...
    private function _is_list(EmailValidationApi2Context $ctx): bool
    {
