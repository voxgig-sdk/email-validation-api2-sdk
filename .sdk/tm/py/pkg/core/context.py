...
from projectname_sdk.core.control import EmailValidationApi2Control
...
class EmailValidationApi2Context:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = EmailValidationApi2Control()
        ...
        if isinstance(sp, EmailValidationApi2Spec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, EmailValidationApi2Result):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, EmailValidationApi2Response):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return EmailValidationApi2Operation({})
        ...
        op = EmailValidationApi2Operation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return EmailValidationApi2Error(code, msg, self)
