...
func NewSslEntity(client *core.EmailValidationApi2SDK, entopts map[string]any) *SslEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SslEntity) GetName() string { return e.name }
...
func (e *SslEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SslEntity) Deleted() bool {
	return e.deleted
}


func (e *SslEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSslEntity(e.client, opts)
}

func (e *SslEntity) Data(args ...any) any {
...
func (e *SslEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Ssl; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SslEntity) DataTyped(data ...Ssl) Ssl {
	if len(data) > 0 {
		return typedFrom[Ssl](e.Data(asMap(data[0])))
	}
	return typedFrom[Ssl](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Ssl (all fields
// optional at the wire level).
func (e *SslEntity) MatchTyped(match ...Ssl) Ssl {
	if len(match) > 0 {
		return typedFrom[Ssl](e.Match(asMap(match[0])))
	}
	return typedFrom[Ssl](e.Match())
}
...
func (e *SslEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SslEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *SslEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SslListMatch and returns []Ssl. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *SslEntity) ListTyped(reqmatch SslListMatch, ctrl map[string]any) ([]Ssl, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Ssl](res), nil
}



func (e *SslEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SslEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SslEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SslEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
