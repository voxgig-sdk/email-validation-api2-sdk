...
// EmailValidationApi2 SDK debug feature
...
class EmailValidationApi2DebugFeature extends EmailValidationApi2BaseFeature
{
    ...
    private function _finish(EmailValidationApi2Context $ctx, bool $ok): void
    {
