...
from projectname_sdk import EmailValidationApi2SDK
from projectname_sdk.core.spec import EmailValidationApi2Spec
from projectname_sdk.core.result import EmailValidationApi2Result
from projectname_sdk.core.response import EmailValidationApi2Response
from projectname_sdk.core.operation import EmailValidationApi2Operation
from projectname_sdk.core.error import EmailValidationApi2Error
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import EmailValidationApi2BaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return EmailValidationApi2Error(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = EmailValidationApi2SDK.test(None, None)
    ...
    def test_done_basic(self):
        ...
        def subject(entry):
            ...
            except EmailValidationApi2Error as e:
                return None, e
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = EmailValidationApi2Result({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = EmailValidationApi2SDK.test(None, None)
        ...
        class TestInitFeature(EmailValidationApi2BaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(EmailValidationApi2BaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_live(self):
        ...
        live_client = EmailValidationApi2SDK({
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = EmailValidationApi2SDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_fetch_def_basic(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = EmailValidationApi2Spec({
            "base": "http://localhost:8080",
            "prefix": "/api",
            "path": "items/{id}",
            "suffix": "",
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = EmailValidationApi2Spec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = EmailValidationApi2SDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = EmailValidationApi2Operation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = EmailValidationApi2SDK.test(None, setup_opts)
