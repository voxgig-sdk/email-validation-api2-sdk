...
|---|---|---|
| `ts/` | @voxgig-sdk/email-validation-api2-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/email-validation-api2-sdk \
      --repository voxgig-sdk/email-validation-api2-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/email-validation-api2-sdk` shows it, and
`npm trust revoke @voxgig-sdk/email-validation-api2-sdk --id=<id>` removes it.
