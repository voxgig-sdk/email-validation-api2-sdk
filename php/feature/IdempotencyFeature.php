...
// EmailValidationApi2 SDK idempotency feature
...
class EmailValidationApi2IdempotencyFeature extends EmailValidationApi2BaseFeature
{
    ...
    private function _mutating(EmailValidationApi2Context $ctx): bool
    {
