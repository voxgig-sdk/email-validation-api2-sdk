...
// EmailValidationApi2 SDK netsim feature
...
class EmailValidationApi2NetsimFeature extends EmailValidationApi2BaseFeature
{
    ...
    private function _simulate(EmailValidationApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(EmailValidationApi2Context $ctx, array $applied): void
    {
        $client = $this->client;
