...
describe("DnsResultDirect", function()
  it("should direct-load-dns_result", function()
    local setup = dns_result_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-dns_result", setup.live and "live" or "unit")
