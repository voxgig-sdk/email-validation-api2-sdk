...
func NewGenerateEntity(client *core.EmailValidationApi2SDK, entopts map[string]any) *GenerateEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GenerateEntity) GetName() string { return e.name }
...
func (e *GenerateEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GenerateEntity) Deleted() bool {
	return e.deleted
}


func (e *GenerateEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGenerateEntity(e.client, opts)
}

func (e *GenerateEntity) Data(args ...any) any {
...
func (e *GenerateEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Generate; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GenerateEntity) DataTyped(data ...Generate) Generate {
	if len(data) > 0 {
		return typedFrom[Generate](e.Data(asMap(data[0])))
	}
	return typedFrom[Generate](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Generate (all fields
// optional at the wire level).
func (e *GenerateEntity) MatchTyped(match ...Generate) Generate {
	if len(match) > 0 {
		return typedFrom[Generate](e.Match(asMap(match[0])))
	}
	return typedFrom[Generate](e.Match())
}
...
func (e *GenerateEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GenerateEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GenerateLoadMatch and returns an Generate. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GenerateEntity) LoadTyped(reqmatch GenerateLoadMatch, ctrl map[string]any) (Generate, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Generate{}, err
	}
	return typedFrom[Generate](res), nil
}



func (e *GenerateEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GenerateEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GenerateEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GenerateEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GenerateEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
