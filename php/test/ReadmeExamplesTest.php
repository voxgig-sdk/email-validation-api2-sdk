...
// EmailValidationApi2 SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (EmailValidationApi2SDK::test)
...
{
    private const SDK_CLASS = 'EmailValidationApi2SDK';
    ...
    private const SDK_BASE = 'emailvalidationapi2_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../emailvalidationapi2_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
