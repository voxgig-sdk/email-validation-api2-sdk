...
// EmailValidationApi2 SDK telemetry feature
...
class EmailValidationApi2TelemetryFeature extends EmailValidationApi2BaseFeature
{
    ...
    private function _close(EmailValidationApi2Context $ctx, bool $ok): void
    {
