...
class DomainEntity
  ...
  # @return [Domain, Hash] the current Domain data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Domain fields)
  def match_get
  ...
  #
  # @param reqmatch [DomainListMatch, Hash, nil] match filter (any subset of
  #   Domain fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Domain>, Array] the matching Domain items; raises EmailValidationApi2Error on failure
