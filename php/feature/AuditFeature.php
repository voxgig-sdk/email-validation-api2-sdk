...
// EmailValidationApi2 SDK audit feature
...
class EmailValidationApi2AuditFeature extends EmailValidationApi2BaseFeature
{
    ...
    private function _emit(EmailValidationApi2Context $ctx, string $outcome): void
    {
