...
// EmailValidationApi2 SDK Ssl entity
...
class SslEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SslEntity($this->_client, $opts);
    }

    /**
     * @param Ssl|array $args Ssl data (assoc-array) to store.
     */
    ...
    /**
     * @return Ssl|array The current Ssl data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Ssl fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Ssl fields).
     */
    ...
    /**
     * List Ssl items matching the given filter.
     *
     * @param SslListMatch|array|null $reqmatch Match filter (any subset
     *   of Ssl fields) as an assoc-array; SslListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Ssl[]|array A list of Ssl items as assoc-arrays at
