...
class RedactEntity
  ...
  # @return [Redact, Hash] the current Redact data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Redact fields)
  def match_get
  ...
  # Create a new Redact.
  #
  # @param reqdata [RedactCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Redact, Hash] the created Redact; raises EmailValidationApi2Error on failure
