...
func NewIpnEntity(client *core.EmailValidationApi2SDK, entopts map[string]any) *IpnEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IpnEntity) GetName() string { return e.name }
...
func (e *IpnEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IpnEntity) Deleted() bool {
	return e.deleted
}


func (e *IpnEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIpnEntity(e.client, opts)
}

func (e *IpnEntity) Data(args ...any) any {
...
func (e *IpnEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Ipn; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IpnEntity) DataTyped(data ...Ipn) Ipn {
	if len(data) > 0 {
		return typedFrom[Ipn](e.Data(asMap(data[0])))
	}
	return typedFrom[Ipn](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Ipn (all fields
// optional at the wire level).
func (e *IpnEntity) MatchTyped(match ...Ipn) Ipn {
	if len(match) > 0 {
		return typedFrom[Ipn](e.Match(asMap(match[0])))
	}
	return typedFrom[Ipn](e.Match())
}
...
func (e *IpnEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IpnEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IpnLoadMatch and returns an Ipn. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *IpnEntity) LoadTyped(reqmatch IpnLoadMatch, ctrl map[string]any) (Ipn, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Ipn{}, err
	}
	return typedFrom[Ipn](res), nil
}



func (e *IpnEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *IpnEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *IpnEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *IpnEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IpnEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
