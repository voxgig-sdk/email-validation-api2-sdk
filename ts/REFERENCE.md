# EmailValidationApi2 TypeScript SDK Reference

Complete API reference for the EmailValidationApi2 TypeScript SDK.
...
```ts
new EmailValidationApi2SDK(options?: object)
```
...
#### `EmailValidationApi2SDK.test(testopts?, sdkopts?)`
...
**Returns:** `EmailValidationApi2SDK` instance in test mode.
...
Alias for `EmailValidationApi2SDK.test()`.
...
Return the parent `EmailValidationApi2SDK` instance.
