...
class DnsResultEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set EMAILVALIDATIONAPI__TEST_DNS_RESULT_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function dns_result_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("EMAILVALIDATIONAPI__TEST_DNS_RESULT_ENTID");
