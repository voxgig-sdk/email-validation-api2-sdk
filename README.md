...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/email-validation-api2-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/email-validation-api2-sdk/tags) |
| Python | `voxgig-sdk-email-validation-api2` | publish pending — [install from git tag](https://github.com/voxgig-sdk/email-validation-api2-sdk/tags) |
| PHP | `voxgig-sdk/email-validation-api2` | publish pending — [install from git tag](https://github.com/voxgig-sdk/email-validation-api2-sdk/tags) |
...
| Ruby | `voxgig-sdk-email-validation-api2` | publish pending — [install from git tag](https://github.com/voxgig-sdk/email-validation-api2-sdk/tags) |
| Lua | `voxgig-sdk-email-validation-api2` | publish pending — [install from git tag](https://github.com/voxgig-sdk/email-validation-api2-sdk/tags) |
