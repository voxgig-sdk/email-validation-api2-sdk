...
function runner.env_override(m)
  local live = runner.getenv("EMAIL_VALIDATION_API2_TEST_LIVE")
  local override = runner.getenv("EMAIL_VALIDATION_API2_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("EMAIL_VALIDATION_API2_TEST_EXPLAIN")
