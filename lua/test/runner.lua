...
function runner.env_override(m)
  local live = runner.getenv("EMAILVALIDATIONAPI2_TEST_LIVE")
  local override = runner.getenv("EMAILVALIDATIONAPI2_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("EMAILVALIDATIONAPI2_TEST_EXPLAIN")
