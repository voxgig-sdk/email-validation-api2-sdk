...
declare class EmailValidationApi2SDK {
    _mode: string;
    _options: any;
    _utility: Utility;
    _features: Feature[];
    ...
    static test(testoptsarg?: any, sdkoptsarg?: any): EmailValidationApi2SDK;
    tester(testopts?: any, sdkopts?: any): EmailValidationApi2SDK;
    toJSON(): {
        name: string;
    };
    toString(): string;
...
declare const SDK: typeof EmailValidationApi2SDK;
export { stdutil, config, BaseFeature, EmailValidationApi2EntityBase, EmailValidationApi2SDK, SDK, };
