...
describe("SslDirect", function()
  it("should direct-list-ssl", function()
    local setup = ssl_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-ssl", setup.live and "live" or "unit")
