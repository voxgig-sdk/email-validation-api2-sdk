...
class WhoiEntity
  ...
  # @return [Whoi, Hash] the current Whoi data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Whoi fields)
  def match_get
  ...
  #
  # @param reqmatch [WhoiListMatch, Hash, nil] match filter (any subset of
  #   Whoi fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Whoi>, Array] the matching Whoi items; raises EmailValidationApi2Error on failure
