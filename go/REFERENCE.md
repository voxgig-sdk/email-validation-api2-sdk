# EmailValidationApi2 Golang SDK Reference

Complete API reference for the EmailValidationApi2 Golang SDK.


## EmailValidationApi2SDK
...
#### `TestSDK(testopts, sdkopts map[string]any) *EmailValidationApi2SDK`
