...
type EmailValidationApi2SDK struct {
	Mode     string
...
func (sdk *EmailValidationApi2SDK) OptionsMap() map[string]any {
...
func (sdk *EmailValidationApi2SDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *EmailValidationApi2SDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *EmailValidationApi2SDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *EmailValidationApi2SDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *EmailValidationApi2SDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *EmailValidationApi2SDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("EmailValidationApi2SDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *EmailValidationApi2SDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *EmailValidationApi2SDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("EmailValidationApi2SDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func (sdk *EmailValidationApi2SDK) DnsResult(data map[string]any) EmailValidationApi2Entity {
...
func (sdk *EmailValidationApi2SDK) Domain(data map[string]any) EmailValidationApi2Entity {
...
func (sdk *EmailValidationApi2SDK) EmailValidate(data map[string]any) EmailValidationApi2Entity {
...
func (sdk *EmailValidationApi2SDK) Generate(data map[string]any) EmailValidationApi2Entity {
...
func (sdk *EmailValidationApi2SDK) Grammar(data map[string]any) EmailValidationApi2Entity {
...
func (sdk *EmailValidationApi2SDK) Ipn(data map[string]any) EmailValidationApi2Entity {
...
func (sdk *EmailValidationApi2SDK) Redact(data map[string]any) EmailValidationApi2Entity {
...
func (sdk *EmailValidationApi2SDK) Ssl(data map[string]any) EmailValidationApi2Entity {
...
func (sdk *EmailValidationApi2SDK) Utility(data map[string]any) EmailValidationApi2Entity {
...
func (sdk *EmailValidationApi2SDK) Whoi(data map[string]any) EmailValidationApi2Entity {
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *EmailValidationApi2SDK {
	...
	sdk := NewEmailValidationApi2SDK(sdkopts)
	sdk.Mode = "test"
