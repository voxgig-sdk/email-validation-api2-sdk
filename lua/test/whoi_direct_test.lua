...
describe("WhoiDirect", function()
  it("should direct-list-whoi", function()
    local setup = whoi_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-whoi", setup.live and "live" or "unit")
