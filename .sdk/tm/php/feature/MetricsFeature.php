...
// EmailValidationApi2 SDK metrics feature
...
class EmailValidationApi2MetricsFeature extends EmailValidationApi2BaseFeature
{
    ...
    private function _record(EmailValidationApi2Context $ctx, bool $ok): void
    {
