# EmailValidationApi2 PHP SDK Reference

Complete API reference for the EmailValidationApi2 PHP SDK.
...
#### `EmailValidationApi2SDK::test($testopts = null, $sdkopts = null)`
...
#### `get_utility(): EmailValidationApi2Utility`
