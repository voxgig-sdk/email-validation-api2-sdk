# EmailValidationApi2 Python SDK



The Python SDK for the EmailValidationApi2 API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/email-validation-api2-sdk/releases)) or
...
client = EmailValidationApi2SDK({
    "apikey": os.environ.get("EMAIL_VALIDATION_API2_APIKEY"),
})
```
...
client = EmailValidationApi2SDK(options)
```
...
```
py/
├── emailvalidationapi2_sdk.py         -- Main SDK module
