# EmailValidationApi2 Python SDK Reference

Complete API reference for the EmailValidationApi2 Python SDK.
...
#### `EmailValidationApi2SDK.test(testopts=None, sdkopts=None)`
