...
(0, node_test_1.describe)('DnsResultDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-dns_result', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-dns_result', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['EMAIL_VALIDATION_API2_TEST_DNS_RESULT_ENTID'];
...
//# sourceMappingURL=DnsResultDirect.test.js.map