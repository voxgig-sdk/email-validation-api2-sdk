...
class IpnEntity
  ...
  # @return [Ipn, Hash] the current Ipn data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Ipn fields)
  def match_get
  ...
  # @return [Ipn, Hash] the loaded Ipn; raises EmailValidationApi2Error on failure
