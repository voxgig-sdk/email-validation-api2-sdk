...
// EmailValidationApi2 SDK timeout feature
...
class EmailValidationApi2TimeoutFeature extends EmailValidationApi2BaseFeature
{
    ...
    private function _with_timeout(EmailValidationApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(EmailValidationApi2Context $_ctx, float $ms): void
    {
        $client = $this->client;
