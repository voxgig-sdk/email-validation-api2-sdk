...
func NewDnsResultEntity(client *core.EmailValidationApi2SDK, entopts map[string]any) *DnsResultEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DnsResultEntity) GetName() string { return e.name }
...
func (e *DnsResultEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DnsResultEntity) Deleted() bool {
	return e.deleted
}


func (e *DnsResultEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDnsResultEntity(e.client, opts)
}

func (e *DnsResultEntity) Data(args ...any) any {
...
func (e *DnsResultEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DnsResult; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DnsResultEntity) DataTyped(data ...DnsResult) DnsResult {
	if len(data) > 0 {
		return typedFrom[DnsResult](e.Data(asMap(data[0])))
	}
	return typedFrom[DnsResult](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DnsResult (all fields
// optional at the wire level).
func (e *DnsResultEntity) MatchTyped(match ...DnsResult) DnsResult {
	if len(match) > 0 {
		return typedFrom[DnsResult](e.Match(asMap(match[0])))
	}
	return typedFrom[DnsResult](e.Match())
}
...
func (e *DnsResultEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DnsResultEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DnsResultLoadMatch and returns an DnsResult. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DnsResultEntity) LoadTyped(reqmatch DnsResultLoadMatch, ctrl map[string]any) (DnsResult, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return DnsResult{}, err
	}
	return typedFrom[DnsResult](res), nil
}



func (e *DnsResultEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DnsResultEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DnsResultEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DnsResultEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DnsResultEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
