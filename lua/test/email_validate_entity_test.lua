...
describe("EmailValidateEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set EMAIL_VALIDATION_API2_TEST_EMAIL_VALIDATE_ENTID JSON to run live")
      return
    end
...
function email_validate_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("EMAIL_VALIDATION_API2_TEST_EMAIL_VALIDATE_ENTID")
