...
class EmailValidationApi2TestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = EmailValidationApi2TestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = EmailValidationApi2TestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = EmailValidationApi2TestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
