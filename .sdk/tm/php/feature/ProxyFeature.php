...
// EmailValidationApi2 SDK proxy feature
...
class EmailValidationApi2ProxyFeature extends EmailValidationApi2BaseFeature
{
    ...
    public function init(EmailValidationApi2Context $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (EmailValidationApi2Context $ctx2, string $url2, array $fetchdef) use ($inner): array {
