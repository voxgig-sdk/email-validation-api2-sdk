...
(0, node_test_1.describe)('IpnDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-ipn', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-ipn', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['EMAIL_VALIDATION_API2_TEST_IPN_ENTID'];
...
//# sourceMappingURL=IpnDirect.test.js.map