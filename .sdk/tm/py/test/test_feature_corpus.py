# EmailValidationApi2 SDK feature corpus test
#
...
def _client(kase):
    ...
    EmailValidationApi2SDK(...), not EmailValidationApi2SDK.test(...): the `test` feature is
    ...
    return EmailValidationApi2SDK(opts)
