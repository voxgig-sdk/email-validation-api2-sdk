...
describe("GenerateDirect", function()
  it("should direct-load-generate", function()
    local setup = generate_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-generate", setup.live and "live" or "unit")
