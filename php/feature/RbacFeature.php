...
// EmailValidationApi2 SDK rbac feature
...
class EmailValidationApi2RbacFeature extends EmailValidationApi2BaseFeature
{
    ...
    private function _required(EmailValidationApi2Context $ctx): ?string
    {
    ...
    private function _reject(EmailValidationApi2Context $ctx, string $required): void
    {
    ...
    private function _track(EmailValidationApi2Context $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
