...
func NewDomainEntity(client *core.EmailValidationApi2SDK, entopts map[string]any) *DomainEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DomainEntity) GetName() string { return e.name }
...
func (e *DomainEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DomainEntity) Deleted() bool {
	return e.deleted
}


func (e *DomainEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDomainEntity(e.client, opts)
}

func (e *DomainEntity) Data(args ...any) any {
...
func (e *DomainEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Domain; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DomainEntity) DataTyped(data ...Domain) Domain {
	if len(data) > 0 {
		return typedFrom[Domain](e.Data(asMap(data[0])))
	}
	return typedFrom[Domain](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Domain (all fields
// optional at the wire level).
func (e *DomainEntity) MatchTyped(match ...Domain) Domain {
	if len(match) > 0 {
		return typedFrom[Domain](e.Match(asMap(match[0])))
	}
	return typedFrom[Domain](e.Match())
}
...
func (e *DomainEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DomainEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *DomainEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DomainListMatch and returns []Domain. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DomainEntity) ListTyped(reqmatch DomainListMatch, ctrl map[string]any) ([]Domain, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Domain](res), nil
}



func (e *DomainEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DomainEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DomainEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DomainEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
