...
// EmailValidationApi2 SDK utility: fetcher

class EmailValidationApi2Fetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; EmailValidationApi2SDK/1.0)';
    ...
    public static function call(EmailValidationApi2Context $ctx, string $fullurl, array $fetchdef): array
    {
