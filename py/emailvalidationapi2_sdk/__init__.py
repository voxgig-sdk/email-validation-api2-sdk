...
from emailvalidationapi2_sdk.core.spec import EmailValidationApi2Spec
from emailvalidationapi2_sdk.core import helpers

# Load utility registration (populates Utility._registrar)
from emailvalidationapi2_sdk.utility import register

# Load features
from emailvalidationapi2_sdk.feature.base_feature import EmailValidationApi2BaseFeature
from emailvalidationapi2_sdk.features import _has_feature, _make_feature
...
class EmailValidationApi2SDK:
    ...
    def __init__(self, options=None):
        ...
        utility = EmailValidationApi2Utility()
    ...
    def get_utility(self):
        return EmailValidationApi2Utility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("EmailValidationApi2SDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def DnsResult(self, data=None) -> "DnsResultEntity":
        ...
        from emailvalidationapi2_sdk.entity.dns_result_entity import DnsResultEntity
    ...
    def Domain(self, data=None) -> "DomainEntity":
        ...
        from emailvalidationapi2_sdk.entity.domain_entity import DomainEntity
    ...
    def EmailValidate(self, data=None) -> "EmailValidateEntity":
        ...
        from emailvalidationapi2_sdk.entity.email_validate_entity import EmailValidateEntity
    ...
    def Generate(self, data=None) -> "GenerateEntity":
        ...
        from emailvalidationapi2_sdk.entity.generate_entity import GenerateEntity
    ...
    def Utility(self, data=None) -> "UtilityEntity":
        ...
        from emailvalidationapi2_sdk.entity.utility_entity import UtilityEntity
        return UtilityEntity(self, data)


    def Whoi(self, data=None) -> "WhoiEntity":
        """Entity factory: client.Whoi().list() / client.Whoi().load({"id": ...})."""
        from emailvalidationapi2_sdk.entity.whoi_entity import WhoiEntity
        return WhoiEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "EmailValidationApi2SDK":
        if sdkopts is None:
            sdkopts = {}
